...
namespace MediaBrowser.Controller.Session
{
    ...
    public interface ISessionManager
    {
        ...
        /// <summary>
        /// Sends a voice chat signal to a session.
        /// </summary>
        /// <param name="sessionId">The identifier of the session.</param>
        /// <param name="signal">The voice chat signal.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Task.</returns>
        Task SendVoiceChatSignal(string sessionId, Model.SyncPlay.VoiceChat.VoiceChatSignal signal, CancellationToken cancellationToken);

        /// <summary>
        /// Sends voice chat state to a session.
        /// </summary>
        /// <param name="sessionId">The identifier of the session.</param>
        /// <param name="state">The voice chat state.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Task.</returns>
        Task SendVoiceChatState(string sessionId, Model.SyncPlay.VoiceChat.VoiceChatState state, CancellationToken cancellationToken);
